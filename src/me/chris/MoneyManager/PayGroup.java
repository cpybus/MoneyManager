...
public class PayGroup
{
	...
	public PayGroup(String groupName, double amount, String type, ArrayList<String> members)
	{
	...
	public String getInfo()
	{
		if(type.equalsIgnoreCase("Flat_Rate"))
			return "§c" + groupName + "§a payment is currently set to §c$" + amount;
	...
	public void getSpecificInfo(Player p)
	{
		...
		{
			p.sendMessage("§c" + groupName + "§a payment is currently set to §c$" + amount);
